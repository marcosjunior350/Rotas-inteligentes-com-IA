...
if __name__ == "__main__":
    ...
    # Define o número de entregadores disponíveis
    ...
    for i in range(NUMERO_DE_ENTREGADORES):
        ...
        rota, custo = otimizar_rota_cluster(grafo_mapa, "restaurante", pontos_do_cluster)

        print(f"  - Rota Otimizada: {' -> '.join(rota)}")
        print(f"  - Custo Total (distância): {custo:.2f}")
